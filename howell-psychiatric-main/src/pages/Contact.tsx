            ...
            <form className="flex flex-col gap-6" onSubmit={(e) => e.preventDefault()}>
              <div className="grid md:grid-cols-2 gap-6">
                <div className="flex flex-col gap-2">
                  ...
                  <input type="text" placeholder="John" className="w-full bg-gray-50 text-gray-900 rounded-2xl px-5 py-4 outline-none focus:ring-2 focus:ring-[#a0a572] focus:bg-white transition-all text-base border border-gray-100" />
                </div>
                <div className="flex flex-col gap-2">
                  <label className="text-sm font-semibold text-gray-700 ml-1">Last Name</label>
                  <input type="text" placeholder="Doe" className="w-full bg-gray-50 text-gray-900 rounded-2xl px-5 py-4 outline-none focus:ring-2 focus:ring-[#a0a572] focus:bg-white transition-all text-base border border-gray-100" />
                </div>
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-700 ml-1">Email Address</label>
                <input type="email" placeholder="john@example.com" className="w-full bg-gray-50 text-gray-900 rounded-2xl px-5 py-4 outline-none focus:ring-2 focus:ring-[#a0a572] focus:bg-white transition-all text-base border border-gray-100" />
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-700 ml-1">Phone Number</label>
                <input type="tel" placeholder="(555) 123-4567" className="w-full bg-gray-50 text-gray-900 rounded-2xl px-5 py-4 outline-none focus:ring-2 focus:ring-[#a0a572] focus:bg-white transition-all text-base border border-gray-100" />
              </div>

              <div className="flex flex-col gap-2">
                <label className="text-sm font-semibold text-gray-700 ml-1">How can we help?</label>
                <textarea placeholder="Briefly describe what you're looking for..." rows={5} className="w-full bg-gray-50 text-gray-900 rounded-2xl px-5 py-4 outline-none focus:ring-2 focus:ring-[#a0a572] focus:bg-white transition-all text-base border border-gray-100 resize-none"></textarea>
              </div>

              <button type="submit" className="w-full bg-[#15453d] text-white py-4 rounded-xl font-bold mt-4 hover:bg-[#a0a572] transition-colors relative after:absolute after:inset-0 after:rounded-xl after:border-[1px] after:border-[#a0a572] after:content-[' '] after:hidden hover:after:block hover:after:animate-[subtlePulse_1.5s_cubic-bezier(0,0,0.2,1)_infinite] flex items-center justify-center gap-2 group">
                Submit Request
